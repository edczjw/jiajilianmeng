<template>
	<view v-if="show" class="dz-badge" :class="[
			isDot ? 'dz-badge-dot' : '', 
			size == 'mini' ? 'dz-badge-mini' : '',
			type ? 'dz-badge--bg--' + type : ''
		]" :style="[{
			top: offset[0] + 'rpx',
			right: offset[1] + 'rpx',
...
<script>
	 ...
	 * @example <dz-badge type="error" count="7"></dz-badge>
	 */
	export default {
		name: 'dz-badge',
		props: {
...
<style lang="scss" scoped>
	...
	// .dz-error {
	// 	background: $dz-type-error;
	// 	color: #fff;
	// }
	
	// .dz-warning {
	// 	background: $dz-type-warning;
	// 	color: #fff;
	// }
	
	// .dz-success {
	// 	background: $dz-type-success;
	// 	color: #fff;
	// }
