<template>
	<view class="dz-grid-item" :hover-class="parentData.hoverClass" 
	 :hover-stay-time="200" @tap="click" :style="{
			background: bgColor,
			width: width,
		}">
		<view class="dz-grid-item-box" :style="[customStyle]" :class="[parentData.border ? 'dz-border-right dz-border-bottom' : '']">
			<slot />
		</view>
	</view>
</template>
