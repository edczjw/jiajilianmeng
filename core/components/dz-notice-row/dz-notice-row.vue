<template>
	...
	>
		<view class="dz-direction-row">
			...
			<view class="dz-icon-wrap"><dz-icon class="dz-left-icon" v-if="volumeIcon == 2" name="notificationfill" :size="volumeSize" :color="computeColor"></dz-icon></view>
			<dz-image v-if="volumeIcon == 3" :src="cover" :width="widthHeight" :height="widthHeight" mode="widthFix"></dz-image>
			<view class="dz-notice-box" id="dz-notice-box">
				<view
					class="dz-notice-content"
				...
				>
					<text class="dz-notice-text" v-for="(item,index) in list" :key="index" @tap="click(index)" :style="[textStyle]" :class="['dz-type-' + type]">
