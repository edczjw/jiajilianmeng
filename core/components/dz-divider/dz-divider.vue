<template>
	<view class="dz-divider" :style="{
		height: height == 'auto' ? 'auto' : height + 'rpx',
		backgroundColor: bgColor,
		marginBottom: marginBottom + 'rpx',
		marginTop: marginTop + 'rpx'
	}" @tap="click">
		<view class="dz-divider-line" :class="[type ? 'dz-divider-line--bordercolor--' + type : '']" :style="[lineStyle]"></view>
		<view v-if="useSlot" class="dz-divider-text" :style="{
			color: color,
 ...
 * @example <dz-divider color="#fa3534">长河落日圆</dz-divider>
 */
export default {
	name: 'dz-divider',
	props: {
