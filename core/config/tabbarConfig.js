...
/* {
	...
	selectedIconPath: "/static/tabbar/tab-rank-selected.png",
	text: '排行榜',
	count: 0,
	isDot: false,
	midButton: false,
	pagePath: '/pages/rank/ranklist',
	jumpType:'switchTab'
}, */
{
	iconPath: "/static/tabbar/shequ.png",
	selectedIconPath: "/static/tabbar/shequ-selected.png",
	text: '社区',
	count: 0,
	isDot: false,
	midButton: false,
...
{
	iconPath: "/static/tabbar/shop-rank.png",
	selectedIconPath: "/static/tabbar/shop-rank-selected.png",
	text: '商城',
	count: 0,
	isDot: false,
	midButton: false,
	pagePath: '/pages/pointsmarket/market',
	jumpType:'switchTab'
},
{
	iconPath: "/static/tabbar/tab-zhua-selected.png",
	selectedIconPath: "/static/tabbar/tab-zhua-selected.png",
	text: '',
	count: 0,
	isDot: false,
	midButton: true,
