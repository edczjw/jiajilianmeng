...
export function calculateConcreteRect(style: {
    ...
    let xRelativeOrigin = {left: 0, center: .5, right:  1}[style.objectPosition?.[0] || "center"]
    let yRelativeOrigin = {top: 0,  center: .5, bottom: 1}[style.objectPosition?.[1] || "center"]
    ...
    let dist2src = (distX: number, distY: number) => [
