		...
		<view class="mescroll-body-content mescroll-wxs-content" :style="{ transform: translateY, transition: transition }" :change:prop="wxsBiz.callObserver" :prop="callProp">
			...
			<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="{'background':mescroll.optDown.bgColor,'color':mescroll.optDown.textColor}">
				<view class="downwarp-content">
					...
					<view class="">
					  <text class="font-weight" style="font-size: 30rpx;">{{ downText }}</text> 
					</view>
				</view>
			</view>
...
<!-- #ifdef MP-WEIXIN || MP-QQ || APP-PLUS || H5 -->
<script src="@/core/components/mescroll-uni/wxs/wxs.wxs" module="wxsBiz" lang="wxs"></script>
<!-- #endif -->

<!-- app, h5使用renderjs -->
<!-- #ifdef APP-PLUS || H5 -->
<script module="renderBiz" lang="renderjs">
	import renderBiz from '@/core/components/mescroll-uni/wxs/renderjs.js';
	export default {
		mixins: [renderBiz]
	}
</script>
...
<script>
	import MeScroll from '@/core/components/mescroll-uni/mescroll-uni.js';
	import MescrollTop from '@/core/components/mescroll-uni/components/mescroll-top.vue';
	import WxsMixin from '@/core/components/mescroll-uni/wxs/mixins.js';
	import mescrollI18n from '@/core/components/mescroll-uni/mescroll-i18n.js';
	import GlobalOption from './wwj-scroll-option.js';
	import mescrollEmpty from '@/core/components/mescroll-empty/mescroll-empty'
	export default {
		mixins: [WxsMixin],
		components: {
			MescrollTop,
...
<style>
	@import "@/core/components/mescroll-uni/mescroll-uni.css";
	@import "@/core/components/mescroll-uni/components/mescroll-down.css";
	@import "@/core/components/mescroll-uni/components/mescroll-up.css";
